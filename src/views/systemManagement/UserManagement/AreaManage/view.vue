        ...
        <el-row>
          <el-col :span="24">
            <div class="title-content">
              <span v-if="manageCodeShow" style="margin-left:40px;margin-right:60px;"><span style="padding-right:10px;">区域编号:</span>{{ manageCode }}</span>
              <span style="margin-right:100px;margin-left:40px;"><span style="padding-right:10px;">区域名称:</span>{{ manageName }}</span>
