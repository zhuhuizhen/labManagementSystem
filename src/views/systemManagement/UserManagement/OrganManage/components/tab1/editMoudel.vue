  ...
  <div class="dialgEditform1">
    ...
    <el-form ref="editForm" :model="editForm" label-width="140px" :rules="editFormRules" class="formAdd">
      <el-row class="edittop">
        <el-col :span="12">
          <el-form-item label="组织ID:" prop="code">
            <el-input v-model="editForm.code" placeholder="请输入组织ID" />
          </el-form-item>
          <el-form-item label="组织负责人:" prop="manager">
            <el-input v-model="editForm.manager" auto-complete="off" placeholder="请输入组织负责人" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          ...
          <el-form-item label="联系电话:" prop="phone">
            <el-input v-model="editForm.phone" autocomplete="off" placeholder="请输入组织联系电话" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
export default {
  ...
  data() {
    ...
    return {
      // 编辑界面数据 state: '',
      editForm: { manageparentName: '', code: '', name: '', assetNum: '', mileage: '', direction: '', unitAddr: '', manager: '', phone: '', claimant: '', claimantPhone: '', orderLevel: '', remark: '' },
      editFormRules: {
  ...
  mounted() {
    this.editForm = Object.assign({}, this.row)
    this.editForm.manageparentName = this.treeName
  },
  methods: {
    // 取消编辑
