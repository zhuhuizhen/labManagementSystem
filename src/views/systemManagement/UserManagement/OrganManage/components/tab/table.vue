<template>
  <div class="managemainTable">
    ...
    <!--确认删除-->
    <!-- <el-dialog title="删除" :visible.sync="removeDioag" append-to-body class="typeInfoAdd outGoing">
      <div class="sureRemove">确认删除？</div>
      <div class="goOut">
        <el-button size="small" class="button-sub" @click="addClose(index, row)">确认</el-button>
    ...
    <!--新增界面-->
    <el-dialog v-if="addFormVisible" v-model="addFormVisible" title="新建组织" :close-on-click-modal="false" :visible.sync="addFormVisible" class="deviceAdd addmanage" width="860px">
      <addMoudel style="height:490px;" @handleGetTree1="handleGetTree1" @handeladdFormVisible="handeladdFormVisible" />
    </el-dialog>
    <!--编辑界面-->
    <el-dialog v-if="editFormVisible" v-model="editFormVisible" title="修改组织" :close-on-click-modal="false" :visible.sync="editFormVisible" :before-close="handleClose" class="deviceAdd addmanage" width="860px">
