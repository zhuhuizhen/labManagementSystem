      ...
      <el-row class="addtop">
        <el-col :span="12">
          <el-form-item label="组织ID:" prop="code">
            <el-input v-model="addForm.code" placeholder="请输入组织ID" />
          </el-form-item>
          <el-form-item label="组织负责人:" prop="manager">
            <el-input v-model="addForm.manager" auto-complete="off" placeholder="请输入组织负责人" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          ...
          <el-form-item label="联系电话:" prop="phone">
            <el-input v-model="addForm.phone" autocomplete="off" placeholder="请输入组织联系电话" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
export default {
  data() {
    ...
    return {
      // 新增界面数据  state: '',
      addForm: { code: '', name: '', assetNum: '', mileage: '', direction: '', unitAddr: '', manager: '', phone: '', claimant: '', claimantPhone: '', orderLevel: '', remark: '' },
